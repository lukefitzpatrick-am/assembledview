...
export default function ProgOOHContainer({
  ...
  }, [watchedLineItems, mbaNumber, feeprogooh, onMediaLineItemsChange]);
  ...
  const handleLineItemValueChange = useCallback((lineItemIndex: number) => {
    ...
    lineItems.forEach((lineItem) => {
      ...
      lineFee = feeprogooh ? (lineMedia / (100 - feeprogooh)) * feeprogooh : 0;
      overallMedia += lineMedia;
      overallFee += lineFee;
...
useEffect(() => {
...
}, [watchedLineItems, feeprogooh, mbaNumber]);
  ...
  }, [watchedLineItems, feeprogooh]); // Removed callback dependencies to prevent infinite loops
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <Card>
          <CardHeader>
            <CardTitle className="pt-4 border-t font-bold text-lg flex justify-between">Prog OOH Media</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t font-medium flex justify-between">
              <span>Prog OOH Media Totals:</span>
              <div className="flex space-x-4">
                <span>Media: ${overallTotals.overallMedia.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                <span>Fees ({feeprogooh}%): ${overallTotals.overallFee.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                      ...
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-2">
                            <CardTitle className="text-lg font-medium">Prog OOH Line Item {lineItemIndex + 1}</CardTitle>
                              ...
                              <CardContent className="py-2 px-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="grid grid-cols-7 gap-3 items-center flex-grow">
                                    ...
                                    <div className="space-y-1">
                                      <FormLabel className="text-xs leading-tight">Fee ({feeprogooh}%)</FormLabel>
                                      <Input
                                        type="text"
                                        className="w-full h-10 text-sm"
                                        value={new Intl.NumberFormat("en-US", {
