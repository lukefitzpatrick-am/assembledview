                                    ...
                                    <FormField
                                      ...
                                      render={({ field }) => {
                                        ...
                                        const calculatedValue = useMemo(() => {
                                          const budget = parseFloat(form.getValues(`radiolineItems.${lineItemIndex}.bursts.${burstIndex}.budget`)?.replace(/[^0-9.]/g, "") || "0");
                                          const buyAmount = parseFloat(form.getValues(`radiolineItems.${lineItemIndex}.bursts.${burstIndex}.buyAmount`)?.replace(/[^0-9.]/g, "") || "1");
                                          ...
                                          form.getValues(`radiolineItems.${lineItemIndex}.bursts.${burstIndex}.budget`),
                                          form.getValues(`radiolineItems.${lineItemIndex}.bursts.${burstIndex}.buyAmount`),
                                          buyType
                                        ]);
