...
import {
  ...
  WEEK_COL_WIDTH_PX as DIGIAUDIO_EXPERT_WEEK_COL_WIDTH_PX,
  ...
  normalizeWeekRect as normalizeDigitalAudioWeekRect,
  weekCellInRect as digiAudioWeekCellInRect,
  ...
  normalizeWeekMergeSelection as normalizeDigitalAudioWeekMergeSelection,
  weekPlainClickPreservesWeekAreaSelection,
  deriveMergeEligibility as deriveDigitalAudioMergeEligibility,
  weekCellExportText,
...
type DigitalAudioWeekRectSelection = ExpertWeekRectSelection
type DigitalAudioMultiCellSelection = ExpertMultiCellSelection
type DigitalAudioWeekMergeSelectionNormalized = WeekMergeSelectionNormalized
...
export function DigitalAudioExpertGrid({
  ...
  const normalizeRowCacheRef = useRef(
    new Map<string, NormalizeRowCacheEntry<DigitalAudioExpertScheduleRow>>()
  )
  ...
  const rowMergeMapCacheRef = useRef(
    new Map<
      string,
      MapBuildCacheEntry<
        DigitalAudioExpertScheduleRow["mergedWeekSpans"],
        DigitalAudioRowMergeMap
      >
    >()
  )
  ...
  const pushRows = useCallback(
    (next: DigitalAudioExpertScheduleRow[]) => {
      const withDates = finalizeRowsPreservingIdentity(next, (r) => {
        ...
        const dates = deriveDigitalAudioExpertRowScheduleYmdFromRow(
          cleared,
          weekColumns,
          campaignStartDate,
          campaignEndDate,
  ...
  const widthForWeekKey = useCallback(
    (k: string): number => {
      ...
      return weekColumnWidths[k] ?? DIGIAUDIO_EXPERT_WEEK_COL_WIDTH_PX
    },
            ...
            ? Math.min(
                ...
                Math.max(
                  ...
                  deltaDaysFromPx(prev.edgeYmd, dx, {
                    ...
                    dayKeysByWeekKey,
                    weekColumnWidths,
                    defaultWeekColWidthPx: DIGIAUDIO_EXPERT_WEEK_COL_WIDTH_PX,
  ...
  }, [dayKeysByWeekKey, feedigiaudio, normalizedRows, weekKeys])
                  ...
                  <thead className="[&_tr]:border-b-0">
                    <tr>
                      <ExpertGridRowReorderHeaderCell
                        ...
                        style={digiAudioExpertHeaderCellBgStyle}
                      />
                        ...
                        return (
                          ...
                          >
                            ...
                            <ExpertGridWeekResizeHandle
                              weekKey={col.weekKey}
                              currentWidth={weekColumnWidths[col.weekKey] ?? DIGIAUDIO_EXPERT_WEEK_COL_WIDTH_PX}
                          ...
                          {(() => {
                            ...
                            for (let wi = 0; wi < weekColumns.length; wi += 1) {
                              ...
                              const tdClassName = cn(
                                ...
                                !isMergedAnchorCell &&
                                  mergeReadyOnCell &&
                                  "digiaudio-expert-week-cell--merge-ready z-[6] bg-pacing-behind-bg ring-2 ring-inset ring-pacing-behind shadow-e0",
