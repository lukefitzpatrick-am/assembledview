...
Media-plan auto-populate (xlsx radio/OOH): load assembled-media-plan-autopopulate. Summarise the pending parse; wait for explicit confirm; then apply_parsed_plan. Never invent spend figures.
