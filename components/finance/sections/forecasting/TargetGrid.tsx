...
/**
 * Section copy of hub `components/finance/hub/panels/forecast/TargetGrid`.
 * Hub original untouched until FN7.
 */
  ...
  const loadTargets = async () => {
    ...
    try {
      ...
      if (body.configured === false) {
        throw new Error(
          body.message ||
            "Target storage is not configured. Set DATABASE_URL for revenue_forecast_lines."
        )
      }
