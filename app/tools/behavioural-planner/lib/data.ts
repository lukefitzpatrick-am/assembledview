...
export const CHANNELS: Channel[] = [
  { id: "tv", name: "Broadcast TV", attn: 18, B: 85, D: 35, cpm: 38, color: "#534AB7",
  ...
  { id: "bvod", name: "BVOD", attn: 24, B: 78, D: 58, cpm: 52, color: "#7F77DD",
  ...
  { id: "ooh-lg", name: "OOH (large format)", attn: 8, B: 72, D: 42, cpm: 18, color: "#1D9E75",
  ...
  { id: "ooh-st", name: "OOH (street/transit)", attn: 6, B: 58, D: 48, cpm: 14, color: "#0F6E56",
  ...
  { id: "audio-br", name: "Broadcast radio", attn: 14, B: 62, D: 55, cpm: 22, color: "#BA7517",
  ...
  { id: "audio-dig", name: "Digital audio", attn: 16, B: 60, D: 62, cpm: 28, color: "#EF9F27",
  ...
  { id: "social-m", name: "Meta (FB/IG)", attn: 9, B: 55, D: 78, cpm: 12, color: "#378ADD",
  ...
  { id: "social-t", name: "TikTok", attn: 11, B: 58, D: 72, cpm: 15, color: "#D4537E",
  ...
  { id: "youtube", name: "YouTube", attn: 13, B: 70, D: 60, cpm: 22, color: "#E24B4A",
  ...
  { id: "search", name: "Search", attn: 7, B: 30, D: 92, cpm: 35, color: "#3B6D11",
  ...
  { id: "display", name: "Programmatic display", attn: 4, B: 42, D: 65, cpm: 8, color: "#888780",
  ...
  { id: "cinema", name: "Cinema", attn: 28, B: 88, D: 32, cpm: 45, color: "#26215C",
