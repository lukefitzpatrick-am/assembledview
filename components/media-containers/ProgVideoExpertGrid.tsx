...
const PROGVIDEO_DESCRIPTOR_TAIL: readonly (keyof ProgVideoExpertScheduleRow)[] = [
  "market",
  "buyingDemo",
  "unitRate",
]
...
export function ProgVideoExpertGrid({
  ...
  const progVideoDescriptorKeys = useMemo(
    () =>
      [
        ...(showBillingCols ? PROGVIDEO_BILLING_FLAG_KEYS : []),
                ...
                <table className="w-max min-w-full border-collapse text-sm">
                  ...
                  <tbody>
                    {normalizedRows.map((row, rowIndex) => {
                      const net = rowNetMedia(row, weekKeys, feeprogvideo)
                      const qtySum =
