...
export const INVESTMENT_MEASURE_DEFS: MeasureDef[] = [
  ...
  },
  {
    ...
    description: "Xero AR invoice totals at MBA×month grain",
  },
  {
    key: "paid_cents",
    label: "Paid",
    group: "actuals",
    groupLabel: "Actuals (Xero)",
    description: "Xero AR amount paid at MBA×month grain",
  },
  {
    ...
    group: "actuals",
    groupLabel: "Actuals (Xero)",
    description: "Booked billable − invoiced (same grain)",
  },
  {
    key: "retainer_cents",
    label: "Retainer",
