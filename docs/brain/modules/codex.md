...
| GET | `/api/codex/client-mbas` | `mbasForClientFromPlans(readPlanMasters(), client_id)` — MBA numbers descending |
...
- 2026-08-14 — Task detail is a right slide-over over the list (`/tasks/[id]` still pasteable; list + panel). MBA is a client-scoped dropdown (desc); checklist ticks optimistic-PATCH.
