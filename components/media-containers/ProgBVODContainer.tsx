...
export default function ProgBVODContainer({
  ...
  }, [watchedLineItems, mbaNumber, feeprogbvod, onMediaLineItemsChange]);
  ...
  const handleLineItemValueChange = useCallback((lineItemIndex: number) => {
    ...
    lineItems.forEach((lineItem) => {
      ...
      lineFee = feeprogbvod ? (lineMedia / (100 - feeprogbvod)) * feeprogbvod : 0;
      overallMedia += lineMedia;
      overallFee += lineFee;
...
useEffect(() => {
  ...
  }, [watchedLineItems, feeprogbvod]); // Removed callback dependencies to prevent infinite loops
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <Card>
          <CardHeader>
            <CardTitle className="pt-4 border-t font-bold text-lg flex justify-between">Prog BVOD Media</CardTitle>
          </CardHeader>
                      ...
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-2">
                            <CardTitle className="text-lg font-medium">Prog BVOD Line Item {lineItemIndex + 1}</CardTitle>
                              ...
                              <CardContent className="py-2 px-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="grid grid-cols-7 gap-3 items-center flex-grow">
                                    ...
                                    <div className="space-y-1">
                                      <FormLabel className="text-xs leading-tight">Fee ({feeprogbvod}%)</FormLabel>
                                      <Input
                                        type="text"
                                        className="w-full h-10 text-sm"
                                        value={new Intl.NumberFormat("en-US", {
