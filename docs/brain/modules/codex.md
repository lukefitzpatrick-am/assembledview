...
- `lib/codex/{repo,types,flag,shadowRoles,queryHelpers,activityDiff,quickAddParse,recurringRule,runRecurring,seedTasks,auth0LoginUpsert,auth0RosterSync,rosterEligibility,auth0RosterStore,rosterEmailAlias,rosterLoginCheck,clientMbas,checklistToggle}.ts`
