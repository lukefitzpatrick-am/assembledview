...
const PROGAUDIO_DESCRIPTOR_TAIL: readonly (keyof ProgAudioExpertScheduleRow)[] = [
  "market",
  "buyingDemo",
  "unitRate",
]
...
export function ProgAudioExpertGrid({
  ...
  const progAudioDescriptorKeys = useMemo(
    () =>
      [
        ...(showBillingCols ? PROGAUDIO_BILLING_FLAG_KEYS : []),
                ...
                <table className="w-max min-w-full border-collapse text-sm">
                  ...
                  <tbody>
                    {normalizedRows.map((row, rowIndex) => {
                      const net = rowNetMedia(row, weekKeys, feeprogaudio)
                      const qtySum =
