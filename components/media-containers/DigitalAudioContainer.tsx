...
export default function DigiAudioContainer({
  ...
  const form = useForm({
    ...
    defaultValues: {
      digiaudiolineItems: emptyChannelLineItemsDefault(),
    },
  });
  ...
  useEffect(() => {
    ...
    const stableItems = assignStableLineItemNumbers<any>(formLineItems, mbaNumber, MEDIA_TYPE_ID_CODES.digitalAudio);
        ...
        <DialogContent className="max-w-[95vw] w-[95vw] max-h-[95vh] h-[95vh] flex flex-col p-4 gap-0 overflow-hidden">
          ...
          <DialogFooter className="flex-shrink-0 border-t pt-3 mt-2">
            <div className="mr-auto flex flex-col gap-1.5">
              <ExpertIncompleteRowsSummary rows={expertDigiAudioRows} />
              {expertApplyPendingPageSave ? (
