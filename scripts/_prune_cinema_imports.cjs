const fs = require("fs")
const p = "components/media-containers/CinemaContainer.tsx"
...
console.log("Cinema imports pruned + ExpertCard wired")
console.log("has ExpertCard import", s.includes("ExpertCard"))
console.log("has CINEMA config", s.includes("CINEMA_EXPERT_CHANNEL_CONFIG"))
