...
const SEARCH_DESCRIPTOR_TAIL: readonly (keyof SearchExpertScheduleRow)[] = [
  "market",
  "buyingDemo",
  "unitRate",
]
...
export function SearchExpertGrid({
  ...
  const searchDescriptorKeys = useMemo(
    () =>
      [
        ...(showBillingCols ? SEARCH_BILLING_FLAG_KEYS : []),
                ...
                <table className="w-max min-w-full border-collapse text-sm">
                  ...
                  <tbody>
                    {normalizedRows.map((row, rowIndex) => {
                      const net = rowNetMedia(row, weekKeys, feesearch)
                      const qtySum =
