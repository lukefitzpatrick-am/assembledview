...
named as (
    select
        ...
        c.CUSTOMER_ID,
        g.CAMPAIGN_NAME,
        /* Normalise display + plan-code suffix — raw Google Ads landing stays immutable. */
        lower(trim(g.AD_GROUP_NAME))                                        as LINE_ITEM_NAME,
...
pmax as (
    select
        ...
        CAMPAIGN_NAME,
        lower(trim(NAME))                                                   as LINE_ITEM_NAME,
