...
describe("create + edit assembly twins (shared helpers)", () => {
  ...
  it("create and edit both render PlanWizardHeader so hero rows cannot drift", () => {
    ...
    assert.match(createSrc, /<AvaMediaplanCreateActions/)
    assert.match(editSrc, /<AvaMediaplanEditActions/)
    assert.doesNotMatch(createSrc, /<AvaMediaplanEditActions/)
    assert.doesNotMatch(editSrc, /<AvaMediaplanCreateActions/)
