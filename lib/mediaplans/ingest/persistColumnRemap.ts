/**
 * Publisher-profile remap helpers — client-safe.
 * Postgres writers live in persistColumnRemap.server.ts.
...
export function previousMappedTo(
  profile: PublisherProfileConfig,
  header: string,
): string | null {
...
export function previousFieldDefault(
  profile: PublisherProfileConfig,
  field: string,
): string | null {
