...
The repo root accumulated ~60 one-off discovery/audit markdown files from past sessions. Their durable knowledge has been folded into this brain (INVARIANTS, KNOWN-ISSUES, BLAST-RADIUS, module pages). This page is the disposition list.
...
- **Session snapshots:** DISCOVERY-repo-state-2026-07-10, WIP-TRIAGE-2026-07-10, TS7_TRIAL, VERIFICATION_REPORT_mp_client_name, HARDCODED_URL_DISCOVERY, docs/security/npm-audit-snapshot (actual file was `npm-audit-snapshot-2026-07-03.txt`), docs/design-refresh/BASELINE.md.
...
- **Non-doc root strays:** `npm-audit-snapshot.json` archived. `_claude_repo_snapshot.tgz` and `tsc-out.txt` were already absent from the tree.
