...
import {
  ...
  WEEK_COL_WIDTH_PX as PROGBVOD_EXPERT_WEEK_COL_WIDTH_PX,
  expertWeekColLayoutStyle as progBvodExpertWeekColLayoutStyle,
  ...
  normalizeWeekRect as normalizeProgBvodWeekRect,
  weekCellInRect as progBvodWeekCellInRect,
  ...
  normalizeWeekMergeSelection as normalizeProgBvodWeekMergeSelection,
  weekPlainClickPreservesWeekAreaSelection,
  deriveMergeEligibility as deriveProgBvodMergeEligibility,
  weekCellExportText,
...
type ProgBvodWeekRectSelection = ExpertWeekRectSelection
type ProgBvodMultiCellSelection = ExpertMultiCellSelection
type ProgBvodWeekMergeSelectionNormalized = WeekMergeSelectionNormalized
