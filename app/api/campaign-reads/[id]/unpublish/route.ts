...
import { CampaignReadError, unpublishCampaignRead } from "@/lib/campaign-read/repo"
...
export async function POST(
  ...
  try {
    const item = await unpublishCampaignRead({ id, actorEmail: email })
    ...
    console.error("[api/campaign-reads/:id/unpublish]", err)
