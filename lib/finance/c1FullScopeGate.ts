/**
 * Plan C S1-P2 — C1 full-scope billable=MBA gate (media + fee + adserving + production).
 *
...
/**
 * Expected ad-serving $ per line — mirrors computeSchedule.distributeAdServing
...
export function collectFullScopeDeltas(args: {
  ...
  if (clientAds.size > 0) {
    ...
    // No per-line stamps — compare month headers for adserving.
