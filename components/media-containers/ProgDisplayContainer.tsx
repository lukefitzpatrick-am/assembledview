...
export default function ProgDisplayContainer({
  ...
  const handleProgDisplayExpertApply = useCallback(() => {
    ...
    form.setValue("lineItems", keyedMerged as ProgDisplayFormValues["lineItems"], {
      shouldDirty: true,
    ...
    const lineItemTotals = watchedLineItems.map((lineItem, index) => {
      ...
      lineItem.bursts.forEach((burst) => {
        ...
        if (lineItem.budgetIncludesFees) {
          ...
          burstMedia = budget;
          burstFee = feeprogdisplay ? (budget / (100 - feeprogdisplay)) * feeprogdisplay : 0;
        }
  ...
  const handleValueChange = useCallback((lineItemIndex: number, burstIndex: number, budgetIncludesFeesOverride?: boolean) => {
    ...
    const bt = coerceBuyTypeWithDevWarn(String(buyTypeRaw || ""), "ProgDisplayContainer.handleValueChange");
...
useEffect(() => {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="overflow-hidden border-0 shadow-md">
          ...
          <CardContent className="space-y-0">
            <MediaContainerSummarySection
              ...
              feeLabel={`Fee (${feeprogdisplay}%)`}
              accentHex={PROG_DISPLAY_MEDIA_HEX}
      ...
      <div>
        {isLoading ? (
          <MediaContainerLoadState loading label="Programmatic Display" />
        ) : (
          <div className="space-y-6">
        ...
        <DialogContent className="max-w-[95vw] w-[95vw] max-h-[95vh] h-[95vh] flex flex-col p-4 gap-0 overflow-hidden">
          ...
          <DialogFooter className="flex-shrink-0 border-t pt-3 mt-2">
            <div className="mr-auto flex flex-col gap-1.5">
              <ExpertIncompleteRowsSummary rows={expertProgDisplayRows} />
              {expertApplyPendingPageSave ? (
