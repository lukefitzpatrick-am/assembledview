const fs = require("fs");
const path =
  "c:/Projects/avmediaplan/.worktrees/refactor-expertgrid-consolidation/components/media-containers/SocialMediaContainer.tsx";
...
console.log("Social ExpertCard replace ok", {
