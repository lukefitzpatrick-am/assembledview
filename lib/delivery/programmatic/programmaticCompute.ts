...
export type ProgrammaticPacingResult = {
...
export type ProgrammaticLineItemMetrics = {
  lineItem: ProgrammaticLineItem
  pacing: ProgrammaticPacingResult
  bursts: any[]
...
export function extractProgrammaticLineItemId(item: ProgrammaticLineItem): string | null {
...
export function summarizeDv360Actuals(
...
function buildCumulativeSeries(dates: string[], actualsDaily: ProgrammaticLineItemMetrics["actualsDaily"]) {
...
function targetMetricForProgrammaticDeliverable(
  deliverableKey: ProgrammaticLineItemMetrics["deliverableKey"] | "deliverable_value" | null,
): "clicks" | "views" | null {
...
export function buildProgrammaticLineItemMetrics(
  ...
  return items.map((item) => {
    ...
    const pacing: ProgrammaticPacingResult = {
      asAtDate,
      spend: {
...
export function buildProgrammaticAggregatedMetrics(
  lineItemMetrics: ProgrammaticLineItemMetrics[],
