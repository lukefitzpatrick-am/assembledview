...
export function buildProgrammaticOohSection(input: {
  progOohLineItems: unknown[] | undefined
  ...
  return buildProgrammaticChannelSection({
    ...
    snowflakeChannel: "programmatic-ooh",
    mediaCurveKey: "progooh",
    curveMetric: "plays",
    lineFamily: "prog_ooh",
    rawLineItems: input.progOohLineItems,
