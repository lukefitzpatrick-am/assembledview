...
type Props = {
  ...
  onClick?: () => void
  /**
   * When true (default), use client-facing {@link DeliveryStatusBadge} for status chips.
   * The agency `/pacing` surface passes false to keep Pacing copy.
   */
          ...
          <div className="flex items-center gap-2">
            ...
            {!hideStatus && resolvedPacingPct !== null ? (
              <span className="inline-flex rounded-full bg-muted px-2 py-0.5 text-[10px] font-medium text-foreground">
                <StatusBadge pacingPct={resolvedPacingPct} size="sm" showIcon={false} showLabel className="bg-transparent px-0 py-0 text-[10px]" />
              </span>
            ) : null}
          </div>
