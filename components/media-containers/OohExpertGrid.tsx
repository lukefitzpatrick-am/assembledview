...
import { ChevronsLeftRight, ChevronsRightLeft, Copy, GitMerge, Grid3x3, Plus, Trash2, X } from "lucide-react"
...
import {
  ...
  normalizeWeekRect as normalizeOohWeekRect,
  weekCellInRect as oohWeekCellInRect,
  ...
  weekRangeOutlineFlags as oohWeekRangeOutlineFlags,
  weekOutlineEdgeClasses as oohWeekOutlineEdgeClasses,
  mergeReadyOutlineFlags as oohMergeReadyOutlineFlags,
  mergeReadyOutlineEdgeClasses as oohMergeReadyOutlineEdgeClasses,
  weekCellInMergePulseHighlight as oohWeekCellInMergePulseHighlight,
  mergeKeysFromRect as oohMergeKeysFromRect,
  normalizeWeekMergeSelection as normalizeOohWeekMergeSelection,
  weekPlainClickPreservesWeekAreaSelection,
  deriveMergeEligibility as deriveOohMergeEligibility,
  weekCellExportText,
...
type OohWeekRectSelection = ExpertWeekRectSelection
type OohMultiCellSelection = ExpertMultiCellSelection
type OohWeekMergeSelectionNormalized = WeekMergeSelectionNormalized
...
export function OohExpertGrid({
  ...
  const widthForWeekKey = useCallback(
    (k: string): number => {
      ...
      return weekColumnWidths[k] ?? OOH_EXPERT_WEEK_COL_WIDTH_PX
    },
            ...
            ? Math.min(
                ...
                Math.max(
                  ...
                  deltaDaysFromPx(prev.edgeYmd, dx, {
                    ...
                    dayKeysByWeekKey,
                    weekColumnWidths,
                    defaultWeekColWidthPx: OOH_EXPERT_WEEK_COL_WIDTH_PX,
        ...
        <CardContent className="space-y-4 pt-5">
          <div className="flex flex-wrap items-baseline justify-between gap-2 text-sm">
            <p className="text-muted-foreground">
              ...
              <span className="mx-1.5 text-border">·</span>
              <span>Drag rows by the grip to reorder line numbers on Apply</span>
            </p>
          </div>
                          ...
                          {(() => {
                            ...
                            for (let wi = 0; wi < weekColumns.length; wi += 1) {
                              ...
                              const tdClassName = cn(
                                ...
                                !isMergedAnchorCell &&
                                  mergeReadyOnCell &&
                                  "ooh-expert-week-cell--merge-ready z-[6] bg-pacing-behind-bg ring-2 ring-inset ring-pacing-behind shadow-e0",
