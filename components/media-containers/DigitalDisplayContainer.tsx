...
}, [watchedLineItems, feedigidisplay, mbaNumber]);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t font-medium flex justify-between">
              ...
              <div className="flex space-x-4">
                ...
                <span>Fees ({feedigidisplay}%): {formatMoney(overallTotals.overallFee, { locale: "en-US", currency: "USD" })}</span>
                              ...
                              <CardContent className="py-2 px-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="grid grid-cols-7 gap-3 items-center flex-grow">
                                    ...
                                    <div className="space-y-1">
                                      <FormLabel className="text-xs leading-tight">Fee ({feedigidisplay}%)</FormLabel>
                                      <Input
                                        type="text"
                                        className="w-full h-10 text-sm"
                                        value={formatMoney(
