...
export default function ProgVideoContainer({
  ...
  useEffect(() => {
    ...
    const stableItems = assignStableLineItemNumbers<any>(formLineItems, mbaNumber, MEDIA_TYPE_ID_CODES.progVideo);
    ...
    const lineItemTotals = watchedLineItems.map((lineItem, index) => {
      ...
      lineItem.bursts.forEach((burst) => {
        ...
        if (lineItem.budgetIncludesFees) {
          ...
          burstMedia = budget;
          burstFee = feeprogvideo ? (budget / (100 - feeprogvideo)) * feeprogvideo : 0;
        }
        ...
        <Card className="overflow-hidden border-0 shadow-md">
          ...
          <CardContent className="space-y-0">
            <MediaContainerSummarySection
              ...
              feeLabel={`Fee (${feeprogvideo}%)`}
              accentHex={PROG_VIDEO_MEDIA_HEX}
              dimensions={["Platform", "Placement", "Bid Strategy", "Buy Type"]}
