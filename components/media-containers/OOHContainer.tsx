...
export default function OohContainer({
  ...
  }, [watchedLineItems, mbaNumber, feeooh, onMediaLineItemsChange]);
  ...
  const handleLineItemValueChange = useCallback((lineItemIndex: number) => {
    ...
    lineItems.forEach((lineItem) => {
      ...
      lineFee = feeooh ? (lineMedia / (100 - feeooh)) * feeooh : 0;
      overallMedia += lineMedia;
      overallFee += lineFee;
  ...
  }, [form, feeooh]); // Removed onTotalMediaChange dependency to prevent infinite loops
...
useEffect(() => {
...
}, [watchedLineItems, feeooh, onLineItemsChange]);
  ...
  }, [watchedLineItems, feeooh]); // Removed callback dependencies to prevent infinite loops
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <Card>
          <CardHeader>
            <CardTitle className="pt-4 border-t font-bold text-lg flex justify-between">OOH Media</CardTitle>
          </CardHeader>
                      ...
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-2">
                            <CardTitle className="text-lg font-medium">OOH Line Item {lineItemIndex + 1}</CardTitle>
                      ...
                      >
                        <CardContent className="space-y-6">
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="space-y-4">
                              <FormItem className="flex items-center space-x-2">
                                <FormLabel className="block text-sm mb-1 self-start mt-4">Type</FormLabel>
                                <FormControl>
                                  <Textarea
                              ...
                              <FormItem className="flex items-center space-x-2">
                                <FormLabel className="block text-sm mb-1 self-start mt-4">Size</FormLabel>
                                <FormControl>
                                  <Textarea
