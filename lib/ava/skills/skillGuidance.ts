...
Campaign read (dashboard Regenerate / "write the read"): load assembled-campaign-read THEN get_campaign_context + get_delivery_snapshot + get_pacing_snapshot + get_campaign_insights. Use the KPI payload supplied with the generate job. Return JSON six beats only. Never invent a cause. Empty beat = "Nothing to report yet."
